...
//        // if the list does not have any element
//        if(head == null)
//            return "[ ]";
//        // create a starting bracket
//        String str = "[ ";
//
//        // initialize a node as a head initially
//        SLLNode<T> tmp = head;
//        // while the node is not null yet, continue iterating throught nodes
//        while(tmp != null){
//            str += tmp.info + " ";
//            tmp = tmp.next;
//        }
